        ...
        public override string Compose()
        {
            ...
            foreach (List<Note> bar in this.StoredChart)
            {
                ...
                foreach (Note x in bar)
                {
                    ...
                    if (x.SlideStart!=null&&x.SlideStart.NoteType.Equals("NST")&&(lastNote.NoteGenre.Equals("SLIDE") && lastNote.TickStamp!=x.TickStamp && !lastNote.Key.Equals(x.Key) && lastNote.SlideStart!=null && lastNote.SlideStart.NoteType.Equals("NST")))
                    {
